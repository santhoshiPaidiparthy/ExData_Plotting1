...
plot(datetime, as.numeric(dat$Global_active_power), type="l", xlab="", ylab="Global Active Power", cex=0.2)

plot(datetime, as.numeric(dat$Voltage), type="l", xlab="datetime", ylab="Voltage")
...
plot(datetime, as.numeric(dat$Global_reactive_power), type="l", xlab="datetime", ylab="Global_reactive_power")
